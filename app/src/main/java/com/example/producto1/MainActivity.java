...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opcion = datos.getInt("opcion_audio");
    ...
    private File createImageFile() throws IOException {
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            mPathFoto = image.getAbsolutePath(); // save this to use in the intent
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            Intent intent = new Intent(this, ActividadPuzzle.class);
            intent.putExtra("opcion_audio", opcion);
            intent.putExtra("mCurrentPhotoPath", mPathFoto);
            startActivity(intent);
        }
